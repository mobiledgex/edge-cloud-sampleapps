...
public class JavaCamera2View extends CameraBridgeViewBase {
    ...
    protected boolean initializeCamera() {
        ...
        try {
            ...
            if (camList.length == 0) {
                Log.e(LOGTAG, "Error: com.mobiledgex.sdkdemo.camera isn't detected.");
                return false;
            }
            ...
            if (mCameraID != null) {
                Log.i(LOGTAG, "Opening com.mobiledgex.sdkdemo.camera: " + mCameraID);
    ...
    private void createCameraPreviewSession() {
        ...
        try {
            if (null == mCameraDevice) {
                Log.e(LOGTAG, "createCameraPreviewSession: com.mobiledgex.sdkdemo.camera isn't opened");
                return;
            }
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface),
                new CameraCaptureSession.StateCallback() {
                    ...
                    public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        ...
                        if (null == mCameraDevice) {
                            return; // com.mobiledgex.sdkdemo.camera is already closed
                        }

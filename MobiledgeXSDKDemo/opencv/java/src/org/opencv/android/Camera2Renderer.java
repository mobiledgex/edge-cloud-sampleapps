...
public class Camera2Renderer extends CameraGLRendererBase {
            ...
            if(mCameraID != null) {
                if (!mCameraOpenCloseLock.tryAcquire(2500, TimeUnit.MILLISECONDS)) {
                    throw new RuntimeException(
                            "Time out waiting to lock com.mobiledgex.sdkdemo.camera opening.");
                }
    ...
    protected void closeCamera() {
        ...
        try {
            ...
            throw new RuntimeException("Interrupted while trying to lock com.mobiledgex.sdkdemo.camera closing.", e);
        } finally {

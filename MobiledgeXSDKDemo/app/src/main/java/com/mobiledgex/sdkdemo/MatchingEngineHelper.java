...
public class MatchingEngineHelper {
    ...
    public class EnhancedLocationUpdate extends AsyncTask<Location, Void, Void> {
       @Override
    ...
    public void doRequestInBackground (final RequestType reqType, final Location location) {
        new BackgroudRequest().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, reqType, location);
    }

    public class BackgroudRequest extends AsyncTask<Object, Void, Void> {
        @Override

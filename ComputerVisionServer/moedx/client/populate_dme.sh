...
mcctl --addr https://127.0.0.1:9900 --skipverify appinst delete region=local app-org=MobiledgeX appname=ComputerVision appvers=2.2 cloudlet-org=dmuus cloudlet=texoma-cloudlet1 cluster=cv-cluster
...
mcctl --addr https://127.0.0.1:9900 --skipverify clusterinst delete region=local cluster=cv-cluster cloudlet-org=dmuus cloudlet=texoma-cloudlet1 cluster-org=MobiledgeX
...
mcctl --addr https://127.0.0.1:9900 --skipverify cloudlet delete region=local cloudlet-org=dmuus cloudlet=texoma-cloudlet1
...
mcctl --addr https://127.0.0.1:9900 --skipverify cloudlet create region=local location.latitude=33.7998 location.longitude=-96.5783 numdynamicips=254 cloudlet-org=dmuus cloudlet=texoma-cloudlet1
...
mcctl --addr https://127.0.0.1:9900 --skipverify clusterinst create region=local cluster=cv-cluster cloudlet-org=dmuus cloudlet=texoma-cloudlet1 cluster-org=MobiledgeX flavor=x1.small deployment=docker
...
# mcctl --addr https://127.0.0.1:9900 --skipverify appinst create region=local app-org=MobiledgeX appname=ComputerVision appvers=2.2 cloudlet-org=dmuus cloudlet=texoma-cloudlet1 cluster=cv-cluster


exit 1

mcctl --addr https://127.0.0.1:9900 --skipverify cloudlet create region=local location.latitude=33.7998 location.longitude=-96.5783 numdynamicips=254 cloudlet-org=dmuus cloudlet=texoma-cloudlet1
mcctl --addr https://127.0.0.1:9900 --skipverify clusterinst create region=local cluster=cv-cluster cloudlet-org=dmuus cloudlet=texoma-cloudlet1 cluster-org=MobiledgeX flavor=x1.small
mcctl --addr https://127.0.0.1:9900 --skipverify appinst create region=local app-org=MobiledgeX appname=ComputerVision appvers=2.2 cloudlet-org=dmuus cloudlet=texoma-cloudlet1 cluster=cv-cluster

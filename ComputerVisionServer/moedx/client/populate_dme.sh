...
mcctl --addr https://127.0.0.1:9900 --skipverify appinst delete region=local apporg=MobiledgeX appname=ComputerVision appvers=2.2 cloudletorg=dmuus cloudlet=texoma-cloudlet1 cluster=cv-cluster
...
mcctl --addr https://127.0.0.1:9900 --skipverify clusterinst delete region=local cluster=cv-cluster cloudletorg=dmuus cloudlet=texoma-cloudlet1 clusterorg=MobiledgeX
...
mcctl --addr https://127.0.0.1:9900 --skipverify cloudlet delete region=local cloudletorg=dmuus cloudlet=texoma-cloudlet1
...
mcctl --addr https://127.0.0.1:9900 --skipverify cloudlet create region=local location.latitude=33.7998 location.longitude=-96.5783 numdynamicips=254 cloudletorg=dmuus cloudlet=texoma-cloudlet1
...
mcctl --addr https://127.0.0.1:9900 --skipverify clusterinst create region=local cluster=cv-cluster cloudletorg=dmuus cloudlet=texoma-cloudlet1 clusterorg=MobiledgeX flavor=x1.small deployment=docker
...
# mcctl --addr https://127.0.0.1:9900 --skipverify appinst create region=local apporg=MobiledgeX appname=ComputerVision appvers=2.2 cloudletorg=dmuus cloudlet=texoma-cloudlet1 cluster=cv-cluster


exit 1

mcctl --addr https://127.0.0.1:9900 --skipverify cloudlet create region=local location.latitude=33.7998 location.longitude=-96.5783 numdynamicips=254 cloudletorg=dmuus cloudlet=texoma-cloudlet1
mcctl --addr https://127.0.0.1:9900 --skipverify clusterinst create region=local cluster=cv-cluster cloudletorg=dmuus cloudlet=texoma-cloudlet1 clusterorg=MobiledgeX flavor=x1.small
mcctl --addr https://127.0.0.1:9900 --skipverify appinst create region=local apporg=MobiledgeX appname=ComputerVision appvers=2.2 cloudletorg=dmuus cloudlet=texoma-cloudlet1 cluster=cv-cluster

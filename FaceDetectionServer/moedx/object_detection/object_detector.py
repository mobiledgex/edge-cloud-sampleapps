# TODO: When we want to move from just detection, to tracking, see sort.py in
# https://github.com/cfotache/pytorch_objectdetecttrack

from __future__ import absolute_import

# Import works different depending on whether this file is run from the
# command line, or is imported by the Django server. Let's support both.
try:
    from models import *
    from utils import *
except ImportError:

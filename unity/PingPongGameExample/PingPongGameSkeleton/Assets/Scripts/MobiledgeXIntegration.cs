...
public class MobiledgeXIntegration
{
   ...
   */
  public string carrierName { get; set; } = "GDDT"; // carrierName depends on the available subscriber SIM card and roaming carriers, and must be supplied by platform API.

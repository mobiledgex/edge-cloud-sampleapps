...
private class MexUtil   // common to Mex... below
{
    ...
    let carrierNameDefault_GDDT: String = "GDDT"
//    let carrierNameDefault_mexdemo: String = "mexdemo"

    var baseDmeHostInUse: String = "GDDT"   // baseDmeHost
...
//        NotificationCenter.default.removeObserver(self)
    ...
    func getAppInstNow()    // called by top right menu
    {
        ...
        let getAppInstListRequest = MexGetAppInst.shared.createGetAppInstListRequest(MexUtil.shared.carrierNameDefault_GDDT, loc)
...
class MexFindNearestCloudlet
{
    ...
    func findNearestCloudlet() //   called by top right menu
    {
        ...
        let findCloudletRequest = createFindCloudletRequest(MexUtil.shared.carrierNameDefault_GDDT, loc)

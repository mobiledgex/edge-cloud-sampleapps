...
import UIKit    // JT 18.09.21
import Foundation    // JT 18.09.21
import CoreGraphics // JT 18.09.21
...
open class SideMenuManager : NSObject {
 ...
 //   open var menuWidth: CGFloat = min( (min((appScreenRect.width), (appScreenRect.height)) * 0.75).round, 240)   // JT 18.09.21
    open var menuWidth: CGFloat = min( min((appScreenRect.width), (appScreenRect.height)) * 0.75, 240)   // JT 18.09.21

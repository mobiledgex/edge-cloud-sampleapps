...
//        Section(name: "Response Body", type: .responseBody)
        WSection(name: "Overview", type: .overview),
        WSection(name: "Request Header", type: .requestHeader),
        WSection(name: "Request Body", type: .requestBody),
        WSection(name: "Response Header", type: .responseHeader),
        WSection(name: "Response Body", type: .responseBody)

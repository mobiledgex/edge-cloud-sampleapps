...
open class RFAboutViewDetailViewController: UIViewController {
    ...
    open override func loadView() {
        ...
        contentTextView.textContainerInset = UIEdgeInsets(top: sizeForPercent(3.125), left: sizeForPercent(3.125), bottom: sizeForPercent(3.125), right: sizeForPercent(3.125))

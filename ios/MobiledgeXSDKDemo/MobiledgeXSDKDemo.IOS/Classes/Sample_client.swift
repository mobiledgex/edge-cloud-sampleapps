...
import Security // JT 18.11.08
    ...
    // JT 18.11.15 todo what should own these?

private var sessionManager: SessionManager? // JT 18.11.08  // JT 18.11.18

var mexClient1: MexRestClient1? // JT 18.11.11  // JT 18.11.18 todo

var mexClient2: MexRestClient2? // JT 18.11.12  // JT 18.11.18 todo

var locationRequest: LocationRequest? // JT 18.11.14

private var sessioncookie = ""  // set by RegisterClient
private var tokenserveruri = "" // set by RegisterClient
var userMarker: GMSMarker? // JT 18.11.11   // set by RegisterClient
                ...
                if cld.key == "Cloudlets" // "cloudlet_location"
                {
                    ...
                    for d in a
                    {
                        ...
                        let cloudlet = Cloudlet(cloudletName, appName, carrierName,
                                                ...
                                                uri,
                                                marker!,
                                                1_048_576,  // JT 18.11.16 actually uses setting alue at run time
                                                0) // JT 18.11.12 todo
...
//                }
                ...
                if cld.key == "cloudlet_location"
                {
                    ...
                    SKToast.show(withMessage: "Found cloest cloudlet")  // JT 18.11.16
        ...
        { notification in
            ...
            _ = postRequest(uri, tokenizedRequest, reply, "VeriyLocation1") // , getReplyCallback);
        }
...
func VerifyLocation(_: String, _: [String: Any], _: inout String)
{
...
func getToken(_ uri: String) // ->String?
{
    ...
    _ = postRequest(uri, [String: Any](), reply, "GetToken")
}
...
public func updateLocSimLocation(_ lat: Double, _ lng: Double)
{
    ...
    Alamofire.request(urlString,
                      ...
                      parameters: jd,
                      encoding: JSONEncoding.default) // headers: headers2

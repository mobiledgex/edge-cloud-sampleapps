...
class ManagedChannel:  GRPCChannel
{
   let isTerminated = false    // JT 18.10.31
  /**
   ...
   * @since 1.0.0
   */
  public func  shutdown() -> ManagedChannel
{
    Swift.print("shutdown todo?")   // JT 18.10.31
    return self
  ...
  {
    Swift.print("isShutdown todo?")   // JT 18.10.31
   return false // JT 18.10.31 todo?
    }
...
//{
//    Swift.print("isShutdown todo?")   // JT 18.10.31
//    return isTerminated // JT 18.10.31 todo?
//    }
  /**
   ...
   * @since 1.0.0
   */
  public func  shutdownNow() -> ManagedChannel
{
    Swift.print("shutdownNow")
   ...
   * @since 1.0.0
   */
    public func  awaitTermination(_ timeout: Int64, _ unit: TimeUnit) ///throws  //InterruptedException;    // JT 18.10.31 todo?
    -> Bool
  {
    Swift.print("awaitTermination")
    return false
    }
   ...
   * @since 1.1.0
   */
    public func getState(_ requestConnection: Bool) throws->String?//ConnectivityState    // JT 18.10.31
    {
    throw  MyError.UnsupportedOperationException("Not implemented");
